...
| `Result_Failure_Inventory_UseEffectFailed` | `GameplayAction.Result.Failure.Paradox.Inventory.UseEffectFailed` |
| `Result_Failure_Inventory_ConsumptionFailed` | `GameplayAction.Result.Failure.Paradox.Inventory.ConsumptionFailed` |
| `Result_Failure_Oxygen_MissingComponent` | `GameplayAction.Result.Failure.Paradox.Oxygen.MissingComponent` |
| `Result_Failure_Oxygen_AlreadyFull` | `GameplayAction.Result.Failure.Paradox.Oxygen.AlreadyFull` |
| `Result_Failure_Oxygen_InvalidRestoreAmount` | `GameplayAction.Result.Failure.Paradox.Oxygen.InvalidRestoreAmount` |
| `Result_Failure_Oxygen_RestoreFailed` | `GameplayAction.Result.Failure.Paradox.Oxygen.RestoreFailed` |
