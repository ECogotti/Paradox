...
namespace ParadoxGameplayTags
{
	...
	PARADOX_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Action_ChronoSpawn);
	PARADOX_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Lock_ChronoSpawn);
	PARADOX_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Result_Failure_ChronoSpawn_InvalidTarget);
	PARADOX_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Result_Failure_ChronoSpawn_Materialization);
	...
	PARADOX_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Result_Failure_Inventory_UseUnsupported);
	PARADOX_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Result_Failure_Inventory_OwnerNotOperational);
	PARADOX_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Result_Failure_Inventory_ItemAlreadyConsumed);
	PARADOX_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Result_Failure_Inventory_UseEffectFailed);
	PARADOX_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Result_Failure_Inventory_ConsumptionFailed);
	PARADOX_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Result_Failure_Oxygen_MissingComponent);
	PARADOX_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Result_Failure_Oxygen_AlreadyFull);
	PARADOX_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Result_Failure_Oxygen_InvalidRestoreAmount);
	PARADOX_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Result_Failure_Oxygen_RestoreFailed);
	...
	PARADOX_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Item_Type_KeyCard_Red);
	PARADOX_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Item_Type_KeyCard_Blue);
	PARADOX_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Item_Type_KeyCard_Green);
